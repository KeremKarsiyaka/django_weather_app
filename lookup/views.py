...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode=" + zipcode + "&distance=5&API_KEY=0EE1AB06-2844-40B1-A33D-34CF9EF61B02")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_description = "(101 - 150) Although general public is not likely to affected at this AQI range, people with lung disease, older adults and children are at a greater risk from ezposure to ozone, whereas persons with heart and lung disease, older adults and children are at greater risk from the presence of particles in the air."
			category_color = "usg"
		elif api[0]['Category']['Name'] == "Unhealthy":
			category_description = "(151 - 200) Eveyone may behin to experience health affects; members of sensitive groups may experience more serious health effects."
